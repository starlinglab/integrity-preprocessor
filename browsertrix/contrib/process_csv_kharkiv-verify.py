...
def ConfigureCrawl(AID, target_urls, meta_data, orgKey, sourceId, related_asset_cid):
    ...
    meta = {
        "private": {
            "additionalData": {
                ...
                "crawl_config": config,
                orgKey: meta_data_private,
            }
        },
        "extras": {orgKey: meta_data_public},
        "sourceId": sourceId,
    }
    if related_asset_cid:
        meta["extras"]["relatedAssetCid"] = related_asset_cid
...
with open("kharkiv2.csv", newline="\n", encoding="utf8") as csvfile:
    ...
    for row in csv_reader:
        ...
        if heading == None:
            ...
            related_asset_cid = json_metadata['relatedAssetCid']
